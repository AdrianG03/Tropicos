...
public void paintComponent ( Graphics g){
    super.paintComponent (g); //llama al metodo paintComponent de la superclase
    Random aleatorio = new Random();// obtiene el generador de n̼meros aleatorios
    ...
    // estabalece la coordenada inicial de la ruta general
